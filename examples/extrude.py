...
t = Empty2()
for plane in as_planes(multiple.faces()):
...
for loc in as_planes(single_multiple.faces()):
...
non_planar = extrude(S.top_face(non_planar, z=-1), amount=2, plane=as_plane(non_planar))
